...
export default function LiveDashboard({
  ...
  const [activeSubTab, setActiveSubTab] = useState('conexion');

  if (activeTab !== 'live') return null;

  return (
    <div className="tab-view active">
      {/* Sub-tabs de Live Dashboard */}
      <nav className="sub-tabs">
        <button className={`sub-tab-btn ${activeSubTab === 'conexion' ? 'active' : ''}`} onClick={() => setActiveSubTab('conexion')}>🔴 Conexión</button>
        <button className={`sub-tab-btn ${activeSubTab === 'musica' ? 'active' : ''}`} onClick={() => setActiveSubTab('musica')}>🎵 Música e Hilos</button>
        <button className={`sub-tab-btn ${activeSubTab === 'reloj' ? 'active' : ''}`} onClick={() => setActiveSubTab('reloj')}>⏱ Reloj y Subathon</button>
        <button className={`sub-tab-btn ${activeSubTab === 'interaccion' ? 'active' : ''}`} onClick={() => setActiveSubTab('interaccion')}>💬 Votaciones y Sonido</button>
        <button className={`sub-tab-btn ${activeSubTab === 'escenas' ? 'active' : ''}`} onClick={() => setActiveSubTab('escenas')}>🎬 Escenas</button>
      </nav>
      ...
      {/* ── INTERACCIÓN, VOTACIONES Y SONIDO ── */}
